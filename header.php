...
<head>
  ...
  <title>Lavender Social Media</title>
    <link rel="icon" href="1.jpg" type="image/png" sizes="16x16"> 
...
<div class="theme-layout">
  ...
  <div class="responsive-header">
    <div class="mh-head first Sticky">
      ...
      <span class="mh-text">
        <a href="" title=""><img src="3.png" alt=""></a>
      </span>
  ...
  <div class="topbar stick">
    <div class="logo">
      <a title="" href="" style="height: 200px;    width: 200px"><img  style="height: 185px;
    margin-top: -46px;" src="3.png" alt=""></a>
    </div>
    ...
    <div class="top-area">
      ...
      <ul class="setting-area">
        <li>
          ...
          <div class="searched">
            <form method="post" action="server.php" class="form-search">
              <input type="hidden"  name="action" value="search">
              <input class="search" type="text" placeholder="Search Friend">
      ...
      <div class="user-img">
        <img width="35" src='<?php print($_SESSION["user"]["img"]) ?>' alt="">
        <span class="status f-online"></span>
        <div class="user-setting">
          <a href="#" title=""><i class="ti-user"></i> edit profile</a>
          <a href="#" title=""><i class="ti-pencil-alt"></i>change password</a>
  ...
  <section>
      <div class="feature-photo">
        <figure><img src='<?php print($_SESSION["user"]["bg_img"]) ?>' alt=""></figure>
        <div class="add-btn">
          ...
          <div class="row merged">
            ...
            <div class="col-lg-10 col-sm-9">
              <div class="timeline-info">
                <ul>
                  <li class="admin-name">
                    <h5><?php print($_SESSION["user"]["name"]) ?></h5>
                  </li>
                  <li>
                    <a class="" href="time-line.html" title="" data-ripple="">Post</a>
